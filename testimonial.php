...
<head>
	...
	<meta name="keywords"
		content="caja de ahorro, testimonios, clientes, sol de noviembre">
	<meta name="description"
		content="Testimonios de clientes - Sol de Noviembre.">
	<title>Sol de Noviembre - Testimonios</title>
	<meta property="og:site_name" content="Sol de Noviembre">
	<meta property="og:url" content="">
	<meta property="og:type" content="website">
	<meta property="og:title" content="Sol de Noviembre - Testimonios">
...
<body>
	<div class="main-page-wrapper">
		...
		<main>
			...
			<!-- feedback-section start -->
			<div class="feedback-section position-relative z-1 pt-140 pt-lg-100 pb-70 pb-lg-60" data-bg-color="#DEEBDC">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 position-relative mb-45">
							<div class="title-one mb-5">
								<h2 class="title text-heding2">Feedback</h2>
								<p class="text-uppercase">BEST FINANCE BANKING</p>
							</div>
							<div id="arrow-nav-5" class="ht-carousel" data-slide-show="1">
								<div class="feedback-wrap-3">
									<p class="feedback-text">Experience rapid loan approval and competitive rates,
										designed
										to suit your financial needs.</p>
									<h4 class="name">Stefan Jong, <span class="designation">Miami</span>
									</h4>
									<div class="d-md-flex align-items-center">
										...
										<p class="rating-text"><span>5.00</span> (27k Reviews)</p>
									</div>
								</div>
								<div class="feedback-wrap-3">
									<p class="feedback-text">Experience rapid loan approval and competitive rates,
							...
							<div
								class="arrow-style-3 d-md-inline-block d-none position-absolute end-0 bottom-0 z-2 mr-15">
								<button data-slick-prev="#arrow-nav-5" class="slick-next slick-arrow">
									<img src="assets/img/icon/arrow-6.svg" alt="arrow">
								</button>
							</div>
						</div>
						<div class="col-lg-6 mb-45">
							<div class="img-holder text-lg-end text-center me-xxl-4">
								<img class="img-fluid" src="assets/img/media/media-26.png" alt="media">
							</div>
						</div>
					</div>
				</div>
			...
			<!-- feedback-section start -->
			<div class="feedback-section position-relative z-1 pt-130 pt-lg-60 pb-70 pb-lg-60">
				<div class="container">
					<div class="row align-items-center mb-4">
						<div class="col-md-6">
							<div class="title-one text-md-start text-center mb-5">
								<h2 class="title text-heding2">Our Testimonial</h2>
							</div>
						</div>
						<div class="col-md-6">
							<div
								...
								<div class="row align-items-center">
									...
									<div class="col-lg-8">
										<div class="content">
											...
											<p class="feedback-text">Bridging banking and technology through seamless
												financial
												innovation.</p>
											<div class="author-content">
												<h5 class="name">John Robert</h5>
			...
			<!-- feedback-section start -->
			<div class="feedback-section pt-70 pt-lg-60 pb-70 pb-lg-60">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-md-6">
							<div class="title-one text-center text-md-start mb-70">
								<h2 class="title">Clients Feedback</h2>
							</div>
						</div>
						<div class="col-md-6 text-md-end text-center">
							<div class="arrow-style-2 d-inline-flex align-items-center mb-70">
								<button data-slick-prev="#arrow-nav-4" class="slick-prev slick-arrow mr-15">
									<img src="assets/img/icon/arrow-left-2.svg" alt="arrow">
								</button>
								<button data-slick-next="#arrow-nav-4" class="slick-next slick-arrow">
					...
					<div class="feedback-slider-three">
						<div id="arrow-nav-4" class="row ht-carousel" data-slide-show="3" data-xl-slide-show="3"
							data-ml-slide-show="3" data-lg-slide-show="3" data-md-slide-show="2" data-xs-slide-show="1">
							<div class="col-lg-6">
								<div class="feedback-wrap-4">
									<div class="content">
										<div class="d-flex align-items-center justify-content-between">
											<div class="flag-box">
												<img class="author" src="assets/img/media/media-5.jpg" alt="author">
												<img class="author-country" src="assets/img/media/media-28.jpg"
													alt="author">
											</div>
											<div class="quote">
												<img class="icon" src="assets/img/icon/icon-28.svg" alt="quote">
											</div>
										</div>
										<p class="feedback-text">Fibank gave me peace during tough financial times.</p>
										<div class="d-xl-flex align-items-center justify-content-between">
											<div class="author-content">
												<h5 class="name">John cuper jonathan</h5>
							...
							<div class="col-lg-6">
								<div class="feedback-wrap-4">
									<div class="content">
										<div class="d-flex align-items-center justify-content-between">
											<div class="flag-box">
												<img class="author" src="assets/img/media/media-6.jpg" alt="author">
												<img class="author-country" src="assets/img/media/media-27.jpg"
													alt="author">
											</div>
											<div class="quote">
												<img class="icon" src="assets/img/icon/icon-28.svg" alt="quote">
										...
										<p class="feedback-text">Your insurance gave me confidence with prompt,
											reliable,
											and promised coverage.</p>
										<div class="d-xl-flex align-items-center justify-content-between">
											<div class="author-content">
												<h5 class="name">Rodela Jahan</h5>
												<p class="designation">Service Holder</p>
											</div>
											<div class="rating">
												<a href="#"><i class="bi bi-star-fill"></i></a>
												<a href="#"><i class="bi bi-star-fill"></i></a>
							...
							<div class="col-lg-6">
								<div class="feedback-wrap-4">
									<div class="content">
										...
										<p class="feedback-text">Your efficient, clear process turned claims into a
											breeze. Grateful!</p>
										<div class="d-xl-flex align-items-center justify-content-between">
											<div class="author-content">
												<h5 class="name">Lucy Rose</h5>
												<p class="designation">Service Holder</p>
											</div>
											<div class="rating">
												<a href="#"><i class="bi bi-star-fill"></i></a>
			...
			<!-- feedback-section start -->
			<div class="feedback-section position-relative z-1 pt-65 pt-lg-60 pb-65 pb-lg-60" data-bg-color="#175557">
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-5 order-lg-last author-thumb-slider">
							<div class="author-avatar">
								<img class="img-fluid" src="assets/img/media/media-31.png" alt="media">
							</div>
							<div class="author-avatar">
								<img class="img-fluid" src="assets/img/media/media-32.png" alt="media">
							</div>
							<div class="author-avatar">
								<img class="img-fluid" src="assets/img/media/media-33.png" alt="media">
							</div>
						</div>
						<div class="col-lg-7 position-relative z-1">
							<div class="author-content-slider">
								<div class="feedback-wrap-5 ps-xxl-1">
									<h6 class="feedback-title">client say</h6>
									<p class="feedback-text">Fibank ensured our mortgage process was simple and smooth.
									</p>
									<div class="author-content">
										<h5 class="name">John cuper jonathan</h5>
										<p class="designation">California, USA</p>
							...
							<div
								class="arrow-style-4 position-absolute z-1 end-0 mr-145 bottom-0 mb-20 d-md-inline-flex align-items-center d-none">
								<button class="pv-p1 slick-arrow mr-15">
									<img src="assets/img/icon/arrow-left-2.svg" alt="arrow">
								</button>
								<button class="nt-p1 slick-arrow">
									<img src="assets/img/icon/arrow-right-2.svg" alt="arrow">
								</button>
							</div>
						</div>
		...
		<footer class="footer-five theme-bg2 position-relative z-1 pt-80">
			...
			<div class="container">
				<div class="row justify-content-center">
					...
					<div class="offset-xxl-1 col-xxl-5 col-xl-6 col-lg-7 text-center text-xl-end">
						<h4 class="widget-title text-xl-start text-center">Newsletter</h4>
						<div class="subscribe-form sub-form-3 d-md-flex align-items-center mb-45">
			...
			<div class="container">
				<div class="copyright-wrap pt-30">
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-6 text-center text-md-start">
							<div class="copyright-text pb-30">
								<a href="#">© Sol de Noviembre - Caja de Ahorro 2024</a>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 text-center text-md-end pb-30">
								...
								<div class="tab-pane show active" role="tabpanel" id="fc1">
									...
									<form action="#">
										<div class="row">
											...
											<div class="col-12">
												<div class="input-wrapper position-relative mb-20">
													...
													<input type="password" placeholder="Enter Password"
														class="pass-log-id">
													<span class="placeholder-icon"><span class="passVicon"><img
																src="assets/img/icon/icon-44.svg"
																alt="icon"></span></span>
												</div>
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												<button class="ht-btn w-100 d-block mt-20">Login</button>
											</div>
										</div>
									</form>
								</div>
									...
									<form action="#">
										<div class="row">
											<div class="col-12">
												<div class="input-wrapper position-relative mb-25">
													<label>Name*</label>
													<input type="text" placeholder="Hamina Hasan">
												</div>
											</div>
											<div class="col-12">
												<div class="input-wrapper position-relative mb-25">
													<label>Email*</label>
													<input type="email" placeholder="haminahasan@gmail.com">
												</div>
											</div>
											<div class="col-12">
												<div class="input-wrapper position-relative mb-20">
